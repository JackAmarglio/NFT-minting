 ...
 */
    ...
    modifier onlyWhiteList() {
        require (whiteList(_msgSender()) == true, "ERC721Streak: Can not create NFT with this address.");
        _;
    }

    function mintItem(address to, string memory _tokenUri) public virtual override onlyWhiteList returns(uint256 tokenId) {
